...
def prepare_dataset(h5ad_path):
    ...
    adata.write("/home/b5cc/sanjukta.b5cc/st3/datasets/5k/k562_5k_train_split_processed.h5ad")
...
def main():
    prepare_dataset("/home/b5cc/sanjukta.b5cc/st3/datasets/5k/k562_5k_train_split.h5ad")
